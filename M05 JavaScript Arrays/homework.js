...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   var a=0;
   arrayOfNums.forEach(element => a+=element);
   return a;
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   var a=0;
   resultadosTest.forEach(element => a+=element);
...
function cuentoElementos(array) {
   ...
   // Tu código:
   var a=array.map((element)=> {return element>18});
   return a.filter((num)=>num===true).length;
}
